...
For a Monte Carlo + GBM crypto case study, exploratory analysis focuses less on feature relationships and more on **return behavior, volatility, and correlation structure**.

## EDA Areas Reviewed

- Historical close-price levels by coin

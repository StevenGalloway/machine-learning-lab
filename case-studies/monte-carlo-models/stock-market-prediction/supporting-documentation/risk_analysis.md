...
- **Jump risk:** GBM does not explicitly capture discontinuous price jumps
...
- Portfolio results may be sensitive to a small set of concentrated holdings
- Recruiters or reviewers may confuse simulation with a trained predictive model unless the README is explicit
